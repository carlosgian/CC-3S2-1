...
public class AirportTest {
    ...
    class EconomyFlightTest {
        ...
        @Test
        @DisplayName("Cuando intentamos agregar dos veces un pasajero, no se agrega una copia del pasajero")
        public void testDoublePassenger(){
            assertAll("Verifica que un pasajero no se pueda agregar dos veces a un vuelo economico.",
        ...
        class RegularPassenger {
            ...
            public void testEconomyFlightRegularPassenger() {
                assertAll("Verifica todas las condiciones para un pasajero regular y un vuelo economico",
                        ...
                        () -> assertEquals(true, economyFlight.addPassenger(checha)),
                        () -> assertEquals(1, economyFlight.getPassengersList().size()),
                        () -> assertEquals("Checha", economyFlight.getPassengersList().get(checha.getName()).getName()),
        ...
        class VipPassenger {
            ...
            public void testEconomyFlightVipPassenger() {
                assertAll("Verifica todas las condiciones para un pasajero VIP y un vuelo economico",
                        ...
                        () -> assertEquals(1, economyFlight.getPassengersList().size()),
                        () -> assertEquals("Lore", economyFlight.getPassengersList().get(lore.getName()).getName()),
    ...
    class BusinessFlightTest {
        ...
        @DisplayName("Cuando intentamos agregar dos veces un pasajero, no se agrega una copia del pasajero")
        public void testDoublePassenger(){
            assertAll("Verifica que un pasajero no se pueda agregar dos veces a un vuelo de negocios.",
        ...
        class VipPassenger {
            ...
            public void testBusinessFlightVipPassenger() {
                assertAll("Verifica todas las condiciones para un pasajero VIP y un vuelo de negocios",
                        ...
                        () -> assertEquals(true, businessFlight.addPassenger(lore)),
                        () -> assertEquals(1, businessFlight.getPassengersList().size()),
                        () -> assertEquals("Lore", businessFlight.getPassengersList().get(lore.getName()).getName()),
        ...
        class VipPassenger {
            ...
            public void testBusinessFlightVipPassenger() {
                assertAll("Verifica todas las condiciones para un pasajero VIP y un vuelo premium",
                        ...
                        () -> assertEquals(true, premiumFlight.addPassenger(lore)),
                        () -> assertEquals(1, premiumFlight.getPassengersList().size()),
                        () -> assertEquals("Lore", premiumFlight.getPassengersList().get(lore.getName()).getName()),
